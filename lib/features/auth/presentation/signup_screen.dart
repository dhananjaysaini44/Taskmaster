          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                   _animateWidget(
                    Icon(Icons.person_add_rounded, size: 64, color: theme.primary),
                    0,
                  ),
                  ...
                  _animateWidget(
                    AuthTextField(
                      ...
                      prefixIcon: Icon(Icons.person_outline, size: 20, color: theme.primary),
                    ),
                    3,
                  ),
                  ...
                  _animateWidget(
                    AuthTextField(
                      ...
                      obscureText: true,
                      validator: (val) => Validators.confirmPassword(_passwordController.text, val),
                      prefixIcon: Icon(Icons.lock_clock_outlined, size: 20, color: theme.primary),
                    ),
                    6,
                  ),
                  SizedBox(height: theme.spacingLG),
